...
FUNCIÓN: Pivot
***************************************************************
    Selecciona el primer elemento de la sublista como pivote y reorganiza los elementos del subarreglo de forma que:
...
***************************************************************
    ...
    aplica búsqueda binaria para encontrar el número buscado.
