/*TAD Arbol Binario de Búsqueda ABB, dirigido a insertar concurrentemente.
...
typedef struct ThreadArgs
{
    arbolBinario *raiz;
    elemento dato;
} ThreadArgs;/*Reserva el espacio necesario para crear el ABB*/
...
/*Recorre un arbol hasta encontrar */
