...
gcc tiempo.c -c
gcc Lineal_Search.c tiempo.o -o Lineal_Search -pthread

echo "Lineal_Search comenzzando"
...
do
  ...
  do
    ./Lineal_Search $N $X < numeros10millones.txt >> Lineal_Search.txt
  done
done
echo "Lineal_Search terminada"
